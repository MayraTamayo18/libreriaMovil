...
class listarUsuarioFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        View= inflater.inflate(R.layout.fragment_listar_usuario, container, false)
        cargar_usuario()
        ...
        try {
            var request= JsonArrayRequest(
                ...
                {response->
                    ...
                    var recycler=View.findViewById<RecyclerView>(R.id.RVUsuario)
